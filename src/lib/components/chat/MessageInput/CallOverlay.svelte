					...
					<div
						class=" {rmsLevel * 100 > 4
							...
							: rmsLevel * 100 > 2
								...
								: rmsLevel * 100 > 1
									? 'size-14'
									: 'size-12'}  transition-all rounded-xl {(model?.info?.meta?.profile_image_url ??
							model?.meta?.profile_image_url ??
							'/static/favicon.png') !== '/static/favicon.png'
							? ' bg-cover bg-center bg-no-repeat'
							: 'bg-black dark:bg-white'}  bg-black dark:bg-white"
						style={(model?.info?.meta?.profile_image_url ??
							model?.meta?.profile_image_url ??
							'/static/favicon.png') !== '/static/favicon.png'
							? `background-image: url('${model?.info?.meta?.profile_image_url ?? model?.meta?.profile_image_url}');`
							: ''}
					/>
				{/if}
				<!-- navbar -->
						...
						<div
							class=" {rmsLevel * 100 > 4
								...
								: rmsLevel * 100 > 2
									...
									: rmsLevel * 100 > 1
										? 'size-44'
										: 'size-40'}  transition-all rounded-xl {(model?.info?.meta
